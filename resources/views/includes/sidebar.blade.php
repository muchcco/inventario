                        ...
                        <li class="kt-menu__item  kt-menu__item--submenu @if (Request::is('inventario*')) kt-menu__item--open @endif" aria-haspopup="true"  data-ktmenu-submenu-toggle="hover">
                            ...
                            <div class="kt-menu__submenu ">
                                ...
                                <ul class="kt-menu__subnav">
                                    <li class="kt-menu__item nav-link @if (Request::is('inventario/equipo*')) kt-menu__item--active @endif" aria-haspopup="true">
                                    ...
                                    <li class="kt-menu__item nav-link @if (Request::is('inventario/asignacionhistorico*')) kt-menu__item--active @endif" aria-haspopup="true">
                                    ...
                                    <li class="kt-menu__item  kt-menu__item--submenu @if (Request::is('inventario/parametro*')) kt-menu__item--open @endif" aria-haspopup="true" data-ktmenu-submenu-toggle="hover">
                                        ...
                                        <div class="kt-menu__submenu ">
                                            <span class="kt-menu__arrow"></span>
                                            <ul class="kt-menu__subnav">
                                                <li class="kt-menu__item nav-link @if (Request::is('inventario/parametro/tipo*')) kt-menu__item--active @endif" aria-haspopup="true">
                                                ...
                                                <li class="kt-menu__item nav-link @if (Request::is('inventario/parametro/subtipo*')) kt-menu__item--active @endif" aria-haspopup="true">
                                                ...
                                                <li class="kt-menu__item nav-link @if (Request::is('inventario/parametro/marca*')) kt-menu__item--active @endif" aria-haspopup="true">
                                                ...
                                                <li class="kt-menu__item nav-link @if (Request::is('inventario/parametro/modelo*')) kt-menu__item--active @endif" aria-haspopup="true">
