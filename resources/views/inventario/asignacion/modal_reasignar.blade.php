...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="modal-body">
                <form id="FormReasignar" name="FormReasignar">
                    ...
                    <div class="form-group validated">
                        ...
                        <select style="width: 100%"  class="custom-select form-control col-lg-12" style="width: 100%" id="responsable" name="responsable" data-col-index="7">
                            <option value="{{ $asignado->IdResponsable }}">{{ $asignado->Responsable }}</option>
                        </select>
                    ...
                    <div class="form-group validated">
                        ...
                        <select style="width: 100%"  class=" custom-select form-control col-lg-12" id="usuario" name="usuario"  data-col-index="7" >
                            <option value="{{ $asignado->IdUsuario }}">{{ $asignado->Usuario }}</option>
                        </select>
        ...
        <a class="btn btn-primary" onclick="ActualizarAsignacion('{{$asignado->IdAsignacion}}')">Guardar</a>
        </div>
    </div>
</div>
<script>
