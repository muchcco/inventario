...
<div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="modal-body">
                <form id="ProgramaForm" name="ProgramaForm">
                    @csrf
                    <input type="hidden" class="form-control" id="Tipo" name="Tipo" value="SW">
        ...
        <div class="modal-footer">
            ...
            <a onclick="guardarPrograma()" class="btn btn-primary" id="btn_guardar_marca">Guardar</a>
        </div>
    </div>
</div>
